odoo.define('studio_for_community.FormViewEdit', function (require) {
"use strict";

    var core = require('web.core');
    var Base = require('studio_for_community.BaseEdit');
    var FormEditContent = require('studio_for_community.FormEditContent');
    var FormEditProperty = require('studio_for_community.FormEditProperty');
