odoo.define('studio_for_community.KanbanViewProperty', function (require) {
"use strict";

    var core = require('web.core');
    var Base = require('studio_for_community.BaseEdit');
    var FieldBasic = require('studio_for_community.FieldBasic');
    var QWeb = core.qweb;
    ...
    var KanbanViewProperty = Base.PropertyBase.extend({
        start: function () {
            ...
            // this.templates = {template1: {label: "Template Default", name: "template1", template: "KanBan.Template1", img: "/studio_for_community/static/src/img/template1.png"},
            //     template2: {label: "Template 2", name: "template2", template: "KanBan.Template2", img: "/studio_for_community/static/src/img/template2.png"}};
