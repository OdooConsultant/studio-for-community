    odoo.define('studio_for_community.PivotViewEdit', function (require) {
"use strict";

    var core = require('web.core');
    var Base = require('studio_for_community.BaseEdit');
    var PivotViewContent = require('studio_for_community.PivotViewContent');
    var PivotViewProperty = require('studio_for_community.PivotViewProperty');
