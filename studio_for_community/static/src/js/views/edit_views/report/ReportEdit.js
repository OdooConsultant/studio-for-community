odoo.define('studio_for_community.ReportEdit', function (require) {
"use strict";

    var core = require('web.core');
    var Base = require('studio_for_community.BaseEdit');
    var ReportContent = require('studio_for_community.ReportContent');
    var ReportProperty = require('studio_for_community.ReportProperty');
